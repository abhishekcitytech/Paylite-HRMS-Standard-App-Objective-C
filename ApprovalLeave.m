...
@interface ApprovalLeave ()

@end

@implementation ApprovalLeave
...
- (void)viewDidLoad
{
    ...
    _tabvApprovalLeave.backgroundView=nil;
    _tabvApprovalLeave.backgroundColor=[UIColor clearColor];
    _tabvApprovalLeave.separatorColor=[UIColor clearColor];
...
#pragma mark - Fetch MyLeave Method
-(void)downloadMyLeave:(NSString *)strSStatus
{
    strIdentifier=@"1";
    ...
    NSString *soapMessage = [NSString stringWithFormat:
                             ...
                             "<SOAP-ENV:Body> \n"
                             "<GetPendingLeave xmlns=\"http://tempuri.org/\"><sCompanyID>%@</sCompanyID>,<sEmployeeID>%@</sEmployeeID>,<sStatus>%@</sStatus>"
                             "</GetPendingLeave> \n"
                             "</SOAP-ENV:Body> \n"
    ...
    [theRequest addValue: @"http://tempuri.org/ISelfService/GetPendingLeave" forHTTPHeaderField:@"SOAPAction"];
...
-(void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
    ...
    {
        if ([elementName isEqualToString:@"GetPendingLeaveResult"])
        {
            NSLog(@"rootis called..");
            arrMLeaveDetails=[[NSMutableArray alloc]init];  
        }
        if ([elementName isEqualToString:@"mytable"])
        {
            NSLog(@"mytable is called..");
            objldt=[[objLeaveDetails alloc]init];
        }
        if ([elementName isEqualToString:@"LeaveStatusCode"])
        {
        ...
        if ([elementName isEqualToString:@"LeaveTypeID"])
        {
            currentElementValue=[NSMutableString string];
        }
        ...
        if ([elementName isEqualToString:@"LeaveFromDate"])
        {
            currentElementValue=[NSMutableString string];
        }
        if ([elementName isEqualToString:@"LeaveToDate"])
        {
            currentElementValue=[NSMutableString string];
        }
        if ([elementName isEqualToString:@"FullHalf"])
        {
            currentElementValue=[NSMutableString string];
        }
        ...
        if ([elementName isEqualToString:@"LeaveApplierComment"])
        {
            currentElementValue=[NSMutableString string];
        }
        if ([elementName isEqualToString:@"NoOfDays"])
        {
            currentElementValue=[NSMutableString string];
        }
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    if ([strIdentifier isEqualToString:@"1"])
    {
        ...
        {
            //NSLog(@"mytable is called..");
            [arrMLeaveDetails addObject:objldt];
        }
        if ([elementName isEqualToString:@"LeaveID"])
        {
            objldt.leaveID=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"ApplicationDate"])
        {
            objldt.ApplicationDate=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"EmployeeCode"])
        {
            objldt.EmployeeCode=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"Employee"])
        {
            objldt.Employee=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"LeaveTypeID"])
        {
            objldt.LeaveTypeID =currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"LeaveStatusCode"])
        {
            objldt.LeaveStatusCode=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"LeaveType"])
        {
            objldt.LeaveType=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"LeaveFromDate"])
        {
            objldt.LeaveFromDate=currentElementValue;
            currentElementValue=nil;
        }
        
        if ([elementName isEqualToString:@"LeaveToDate"])
        {
            objldt.LeaveToDate=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"FullHalf"])
        {
            objldt.FullHalf=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"Reason"])
        {
            objldt.Reason=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"LeaveApplierComment"])
        {
            objldt.LeaveApplierComment=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"NoOfDays"])
        {
            objldt.NoOfDays=currentElementValue;
            currentElementValue=nil;
            
        }
        if ([elementName isEqualToString:@"EmployeeID"])
        {
            objldt.EmployeeID=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"ReportedToStatus"])
        {
            objldt.ReportedToStatus=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"ApprovalAuthorityStatus"])
        {
            objldt.ApprovalAuthorityStatus=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"HRStatus"])
        {
            objldt.HRStatus=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"FinalAuthorityStatus"])
        {
            objldt.FinalAuthorityStatus=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"L1Senior"])
        {
            objldt.L1Senior=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"L2Senior"])
        {
            objldt.L2Senior=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"L3Senior"])
        {
            objldt.L3Senior=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"L4Senior"])
        {
            objldt.L4Senior=currentElementValue;
            currentElementValue=nil;
        }
        if ([elementName isEqualToString:@"Images"])
        {
            objldt.Leaveimages=currentElementValue;
            currentElementValue=nil;
        }
    }
    else
...
- (void)parserDidEndDocument:(NSXMLParser *)parser
{
    if ([strIdentifier isEqualToString:@"1"])
    {
        NSLog(@"arrMLeaveDetails :>>> %@",arrMLeaveDetails);
        
        if ([arrMLeaveDetails count]==0)
        {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    objLeaveDetails *obj=[arrMLeaveDetails objectAtIndex:indexPath.section];
    
    UILabel *cellLable1,*cellLable2,*cellLable3,*cellLable4;
    
    cellLable1=[[UILabel alloc] initWithFrame:CGRectMake(14,10, _tabvApprovalLeave.frame.size.width-10, 17)];
    cellLable2=[[UILabel alloc] initWithFrame:CGRectMake(14,CGRectGetMaxY(cellLable1.frame)+10, _tabvApprovalLeave.frame.size.width-10, 17)];
    cellLable3=[[UILabel alloc] initWithFrame:CGRectMake(14,CGRectGetMaxY(cellLable2.frame)+10, _tabvApprovalLeave.frame.size.width-10, 17)];
    cellLable4=[[UILabel alloc] initWithFrame:CGRectMake(14,CGRectGetMaxY(cellLable3.frame)+10, _tabvApprovalLeave.frame.size.width-10, 17)];
    ...
    cellLable2.text=obj.LeaveType;
    cellLable3.text=[NSString stringWithFormat:@"%@ - %@",obj.LeaveFromDate,obj.LeaveToDate];
    cellLable4.text=[NSString stringWithFormat:@"%@ Days",obj.NoOfDays];
    
    if ([obj.Leaveimages isEqualToString:@""]) {
    }
    else{
         UIButton *btnAttch=[UIButton buttonWithType:UIButtonTypeCustom];
         btnAttch.frame=CGRectMake(CGRectGetWidth(_tabvApprovalLeave.frame)-64,CGRectGetMinY(cellLable2.frame),32,32);
    ...
    viewBottomCell.frame=CGRectMake(14,120, _tabvApprovalLeave.frame.size.width-28,60);
    ...
    UILabel *lblSeparator=[[UILabel alloc] initWithFrame:CGRectMake(0,189.7,_tabvApprovalLeave.frame.size.width,0.3)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[dicTemp valueForKey:@"EmployeeID"]isEqualToString:obj.L1Senior])
    {
        ...
        {
            //pending
            ApprovalLeaveDetails *objDemo;
            CGSize screenSize=[[UIScreen mainScreen]bounds].size;
            if ([[UIDevice currentDevice]userInterfaceIdiom]==UIUserInterfaceIdiomPhone)
            {
                if (screenSize.height==568.0f){
                    //5S
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetails5S" bundle:nil];
                }
                else if(screenSize.height == 667.0f){
                    //6
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetails6" bundle:nil];
                }
                else if(screenSize.height == 736.0f){
                    //6Plus
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetails6Plus" bundle:nil];
                }
                else if(screenSize.height == 812.0f){
                    //X
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetailsX" bundle:nil];
                }
                else if(screenSize.height == 896.0f){
                    //XSMAX XR
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetailsXSMAX" bundle:nil];
                }
                else{
                    //4S
                    objDemo = [[ApprovalLeaveDetails alloc] initWithNibName:@"ApprovalLeaveDetails" bundle:nil];
                }
            }
            else
            {
...
#pragma mark - Open Attachement Method
-(void)pressOpenAttachment:(id)sender
{
    UIButton *btn=(UIButton *)sender;
    objLeaveDetails *obj=[arrMLeaveDetails objectAtIndex:btn.tag];
    NSLog(@"obj.Images:%@",obj.Leaveimages);
    [self openAttachmentPopup:[NSString stringWithFormat:@"%ld",(long)btn.tag] imgUrl:[NSString stringWithFormat:@"%@",obj.Leaveimages]];
}
