...
NSInteger minYear = 2016;
NSInteger maxYear = 2090;
...
-(NSArray *)nameOfYears
{
    ...
    {
        NSString *yearStr = [NSString stringWithFormat:@"%lu", (unsigned long)year];
...
-(NSString *)currentMonthName
{
    ...
    NSLog(@"[formatter stringFromDate:[NSDate date]--%@",[formatter stringFromDate:[NSDate date]]);
