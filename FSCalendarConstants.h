...
#define FSCalendarStandardSelectionColor   FSColorRGBA(30,161,242,1.0)
#define FSCalendarStandardTodayColor       FSColorRGBA(206,215,221,1.0)
#define FSCalendarStandardTitleTextColor   FSColorRGBA(14,69,221 ,1.0)
#define FSCalendarStandardEventDotColor    FSColorRGBA(255,255,255,1.0)
